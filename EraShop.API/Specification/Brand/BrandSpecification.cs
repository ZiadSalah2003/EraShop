...
{
    public class BrandSpecification : Specification<Entities.Brand, int>
    {
        ...
        public BrandSpecification(Expression<Func<Entities.Brand, bool>>? expression) : base(expression)
        {
            AddOrderBy(b => b.Name);
            AddIncludes();
        }
